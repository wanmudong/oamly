...
public class SysUserException extends  RuntimeException {
    ...
    public SysUserException(String errorCode, String errorMsg){
        super(errorMsg);
        this.errorCode = errorCode;
    }
    public SysUserException(OrderExceptionEnum orderExceptionEnum){
        super(orderExceptionEnum.getErrorMsg());
        this.errorCode = orderExceptionEnum.getErrorCode();
    }

    public SysUserException(String errorCode, String errorMsg,Throwable throwable){
        super(errorMsg,throwable);
        this.errorCode = errorCode;
    }
    public SysUserException(OrderExceptionEnum orderExceptionEnum,Throwable throwable){
